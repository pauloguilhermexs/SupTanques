...
const static double MY_PI=3.14159265359;
...
static double normal()
{
  ...
  if (u2 < 0.0)
  {
    ...
    double angulo=2.0*MY_PI*u2;      // >0.0 a 2PI
    z1 = raio*cos(angulo);
    z2 = raio*sin(angulo);
    return z1;
  }
...
void Tanks::simulate() const
{
  ...
  const static double OverflowArea=MY_PI*pow2(OverflowRadius);
